...
<head>
  ...
  <title>Happy Birthday Big mummy nurse ❤️</title>
  <style>
    body {
    ...
    .card {
      background: linear-gradient(135deg, #ffe7e7 60%, #f4e1ff 100%);
      border-radius: 24px;
      padding: 24px;
    ...
    .open-link {
      ...
      padding: 18px 36px;
      border-radius: 20px;
      background: linear-gradient(90deg,#ffd6e0 0%,#cfefff 100%);
      color: #6e2d70;
      font-weight: 700;
    ...
    .cake-deco {
      ...
      width: 140px;
      height: 8px;
      background: repeating-linear-gradient(90deg,#f7b8e2 0 16px,#a7e7f6 16px 32px);
      border-radius: 4px;
    }
    .candles-row {
      position: absolute;
